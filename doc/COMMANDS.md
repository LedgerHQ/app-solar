...
<= 9000
=> e0c101000f0d0048656c6c6f2c20576f726c6421  # ("Hello, World!")
<= <signature(64)>, 0x9000
```
...
| `0x6700` | `SW_WRONG_LENGTH`             | `Lc` or minimum APDU length is incorrect         |
...
| `0xB009` | `SW_REQ_ORDER_FAIL`           | Requests are not in order                        |
| `0xB00A` | `SW_DISPLAY_FAIL`             | Generic display failure                          |
| `0xB00B` | `SW_PUBKEY_PARSING_FAIL`      | Public key parsing failed                        |
| `0xB00C` | `SW_VALIDATION_HASH_MISMATCH` | Validation hash failed                           |
